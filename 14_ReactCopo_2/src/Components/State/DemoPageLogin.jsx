...
export default class DemoPageLogin extends Component {
    ...
    renderLogin = () => {
        if(this.state.isLogin) {
            return <div>
                <button className='btn btn-success'>Profile - Hai</button>
            ...
            <div className='bg-dark text-white py-3'>
                <div className='d-flex'>
                    ...
                    <div className='text-end w-25 px-5'>
                        ...
                        {/* {this.state.isLogin ? <button className='btn btn-success'>Profile - Hai</button> : <button className='btn btn-success'>Login</button>} */}
