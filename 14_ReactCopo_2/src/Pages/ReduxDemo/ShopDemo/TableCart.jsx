...
import { delProductAction, changeQuantityAction } from '../../../redux/reducers/cartReducer.jsx';

class TableCart extends Component {
    render() {
        let { cart, number, dispatch } = this.props;
        console.log('Phải bấm vào mới hiện, đmm', this.props);
        return (
                        ...
                        return <tr key={item.id}>
                            ...
                            <th>
                                <button className='btn btn-danger' onClick={() => {
                                    ...
                                    //Cách 1: action = {type:'cartReducer/delProductAction',payload: item.id}
                                    this.props.dispatch(action);
